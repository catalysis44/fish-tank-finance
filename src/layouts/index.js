        ...
        <div class="list_group">
          <aside class="menu">
            ...
            <ul class="menu-list">
              ...
              <li><a><img src="assets/sidebar/market.png"/> <div  style={{flexDirection:'column',alignItems:'flex-start'}}><div style={{alignItems:'flex-start',lineHeight:'10px'}}>{t("The Market")}</div><div style={{alignItems:'flex-start',fontSize:11}}>(Maintenance)</div></div></a></li>
              <li  style={{ display: 'none' }}><NavLink onClick={toggleSidebar} to="/market" activeClassName="is_active"><img src="assets/sidebar/market.png" /> <div>{t("The Market")}</div></NavLink></li>
